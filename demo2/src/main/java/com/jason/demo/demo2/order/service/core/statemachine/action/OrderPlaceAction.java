...
public class OrderPlaceAction implements Action<OrderStatusEnum, OrderEventEnum, OrderContext> {
    ...
    @Autowired
    public OrderPlaceAction(OrderRepository orderRepository) {
        this(orderRepository, null, null);
    }

    public OrderPlaceAction(OrderRepository orderRepository, Object orderItemRepository, Object productStockHotService) {
